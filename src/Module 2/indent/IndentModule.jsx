...
const IndentModule = () => {
  ...
  if (showForm) return <IndentForm onBack={() => setShowForm(false)} />;
  if (selectedIndent) return <IndentDetails indent={selectedIndent} onBack={() => setSelectedIndent(null)} />;
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => setShowForm(true)}><Plus size={20} /> Add Indent</Button>
      </div>
