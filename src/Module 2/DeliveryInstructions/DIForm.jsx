...
const DIForm = ({ onBack }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <h2 className="text-2xl font-bold mb-6 text-gray-900">Create Delivery Instruction</h2>
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b-2 border-blue-200">
              ...
              <th className="px-4 py-3 text-center text-xs font-bold text-blue-900 uppercase w-24">Action</th>
            </tr>
          </thead>
          <tbody>
            {addedItems.length > 0 ? (
              ...
              <tr>
                <td colSpan="4" className="px-4 py-10 text-center text-gray-400 italic">No items added to the preview list yet.</td>
              </tr>
            )}
          </tbody>
        </table>
