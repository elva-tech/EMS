...
const WorkOrderModule = () => {
  ...
  if (view === 'add') return <WorkOrderForm onBack={() => setView('list')} />;
  if (view === 'details' && selectedEntry) return <WorkOrderList entry={selectedEntry} onBack={() => setView('list')} />;
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => setView('add')}><Plus size={20} /> Add Work Order</Button>
      </div>
