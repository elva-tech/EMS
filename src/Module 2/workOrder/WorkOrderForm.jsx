 ...
 const handleCreate = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <h2 className="text-2xl font-bold mb-6 text-gray-900">New Work Order</h2>
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            {addedItems.length > 0 ? (
              ...
              <tr><td colSpan="4" className="px-6 py-8 text-center text-gray-400 italic">No materials added to estimate yet.</td></tr>
            )}
          </tbody>
        </table>
      </div>
